...
if __name__ == "__main__":
    ...
    frame_count = 77
    frames = [f"doom_2/doom2-1-frame{i}" for i in range(1, frame_count)]
    # Save them to a temporary dictionary
    frame_imports: Dict[int, np.ndarray] = {}
    for i, filename in enumerate(frames):
        print(f"Importing frame {i + 1}/{frame_count}.", end="\r")
    ...
    aether_renderer.dimensions.window_h = 240
    aether_renderer.dimensions.window_w = 428
    while True:
